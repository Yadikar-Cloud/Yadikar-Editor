tinymce.PluginManager.add('savetoonedrive', function(editor, url) {
    ...
    async function performSave(token, dialogApi) {
        ...
        try {
            ...
            // Upload to OneDrive
            const uploadUrl = `https://graph.microsoft.com/v1.0/me/drive/root:/${fullFileName}:/content`;
