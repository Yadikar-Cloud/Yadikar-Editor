tinymce.PluginManager.add('file', function(editor, url) {
    ...
    editor.ui.registry.addMenuItem('information', {
        ...
        icon: 'info',
        onAction: function() {
        	if(window.currentLocalFile && window.currentLocalFile.fileAttr) {
            	fileAttributes(window.currentLocalFile.fileAttr);
            } else {
	...
	async function saveFile() {
		try {
		    ...
		    if(window.showSaveFilePicker) {
		    	 ...
		    	 file = await window.fileHandle.getFile();
	...
	function fileAttributes(object) {
