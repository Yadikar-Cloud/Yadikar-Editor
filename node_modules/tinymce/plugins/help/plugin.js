...
(function () {
    ...
    var tab = function (editor) {
      ...
      var version = editor.getParam('help_version_major') + '.' + editor.getParam('help_version_minor');
      var changeLogLink = '<a>Yadikar Text Editor ' + version + '</a>';
      var htmlPanel = {
        type: 'htmlpanel',
