...
function initializeTinyMCE(customSettings = {}, initialContent = '') {	
  ...
  tinymce.init({
    ...
    content_style: `body { font-family: Verdana,UKIJ,sans-serif; font-size: ${settings.contentFontSize || '16px'}; } .page { padding: ${PAGE_MARGIN}px; }`,
    ...
    setup: function(editor) {
			editor.ui.registry.addNestedMenuItem('opensubmenu', {
					...
					getSubmenuItems: function() {
						  return 'openfromcomputer openfromgdrive openfromdropbox openfromeondrive';
					}
			});
      // Save submenu
      editor.ui.registry.addNestedMenuItem('savesubmenu', {
          ...
          icon: "save",
          getSubmenuItems: function() {
              return 'savetocomputer savetogdrive savetodropbox savetoonedrive';
          }
      });			      
