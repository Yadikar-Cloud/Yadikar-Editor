...
function initializeTinyMCE() {
  ...
  tinymce.init({
    ...
    content_style: "@font-face { font-family: AlpEkran; src: url(./assets/fonts/AlpEkran1.ttf); } @font-face { font-family: UKIJEkranRegular; src: url(./assets/fonts/UKIJEkran.ttf); } @font-face { font-family: UKIJChiwerKesmeRegular; src: url(./assets/fonts/UKIJChiK.ttf); } @font-face { font-family: UKIJCJKRegular; src: url(./assets/fonts/UKIJCJK.ttf); } @font-face { font-family: UKIJKufiRegular; src: url(./assets/fonts/UKIJKu.ttf); } body { font-family: UKIJEkranRegular,UKIJ,sans-serif; }",
    ...
    font_formats: "Andale Mono=andale mono,times; Arial=arial,helvetica,sans-serif; Arial Black=arial black,avant garde; Book Antiqua=book antiqua,palatino; Comic Sans MS=comic sans ms,sans-serif; Courier New=courier new,courier; Georgia=georgia,palatino; Helvetica=helvetica; Impact=impact,chicago; Microsoft Uighur=Microsoft Uighur; AlpEkran=AlpEkran; UKIJEkranRegular=UKIJEkranRegular; UKIJChiwerKesmeRegular=UKIJChiwerKesmeRegular; UKIJCJKRegular=UKIJCJKRegular; UKIJKufiRegular=UKIJKufiRegular; Symbol=symbol; Tahoma=tahoma,arial,helvetica,sans-serif; Terminal=terminal,monaco; Times New Roman=times new roman,times; Trebuchet MS=trebuchet ms,geneva; Verdana=verdana,geneva; Webdings=webdings; Wingdings=wingdings,zapf dingbats",
    language: "ug",
    templates: [
      {
        title: "\u0628\u0627\u063A\u0627\u0642",
