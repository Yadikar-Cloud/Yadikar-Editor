...
function initializeTinyMCE() {
  ...
  tinymce.init({
    ...
    content_style: "@font-face { font-family: AlpEkran; src: url(./assets/fonts/AlpEkran.ttf); } @font-face { font-family: UKIJEkranRegular; src: url(./assets/fonts/UKIJEkran.ttf); } @font-face { font-family: UKIJChiwerKesmeRegular; src: url(./assets/fonts/UKIJChiK.ttf); } @font-face { font-family: UKIJCJKRegular; src: url(./assets/fonts/UKIJCJK.ttf); } @font-face { font-family: UKIJKufiRegular; src: url(./assets/fonts/UKIJKu.ttf); } body { font-family: UKIJEkranRegular,UKIJ,sans-serif; }",
